...
import com.beehyv.iam.utils.Credentials;
...
public class UserService {
    ...
    public Long addUser(UserRequestDto userRequestDto, boolean isSuperAdmin) {
        ...
        User userEmailInDb = userManager.findByEmail(userRequestDto.getEmail());
    ...
    public UserResponseDto getUser(Long id) {
        ...
        if (isSuperAdmin || (isAdmin && (Objects.equals(userOrganisationId, manufacturerId)))) {
            ...
            List<UserRoleCategory> roleCategories = userRoleCategoryManager.findByUserId(id);
