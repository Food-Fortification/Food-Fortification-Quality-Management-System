...
import static org.path.fortification.mapper.BaseMapper.stateMapper;
...
class LotServiceImplTest {
    ...
    public void testGetLotActionsWithCategoryIdAndLotId() {
        ...
        org.path.fortification.dto.responseDto.StateResponseDto stateResponseDto = new org.path.fortification.dto.responseDto.StateResponseDto();
        ...
        List<org.path.fortification.dto.responseDto.StateResponseDto> expectedResponse = Collections.singletonList(stateResponseDto);
        ...
        List<org.path.fortification.dto.responseDto.StateResponseDto> actualResponse = lotService.getLotActions(categoryId, lotId, actionType, sampleState);
    ...
    public void testGetLotActionsWithCategoryIdAndLot() {
        ...
        List<org.path.fortification.dto.responseDto.StateResponseDto> actualResponse = lotService.getLotActions(categoryId, lot, actionType, sampleState);
    ...
    void testGetLotActions() {
        ...
        // Act
        List<org.path.fortification.dto.responseDto.StateResponseDto> result = lotService.getLotActions(categoryId, lot, actionType, sampleState);
